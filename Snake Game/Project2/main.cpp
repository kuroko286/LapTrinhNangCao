...
void drawHighScore() {
	drawText("<-- Back", 20, 20, 100, 50);
	drawText("Top 1 : " + to_string(highScoreArr[0]), 200, 150, 180, 70);
	drawText("Top 2 : " + to_string(highScoreArr[1]), 200, 220, 180, 70);
	drawText("Top 3 : " + to_string(highScoreArr[2]), 200, 290, 180, 70);
	show();
}
void drawGameLevel() {
...
void getHighScore(int s) {
	...
	else if (s > highScoreArr[1]) {
		highScoreArr[2] = highScoreArr[1];
		highScoreArr[1] = s;
		
	}
	else if (s > highScoreArr[2]) {
		highScoreArr[2] = s;
	}
}
